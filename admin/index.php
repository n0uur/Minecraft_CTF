...
{
	$sql ='SELECT * from userdata where username="'.$_POST["username"].'" and permission >= 20;';
	...
	{
		header('Location: ./index.php?msg=ไม่พบบัญชีนี้ในระบบหรือคุณไม่ได้รับสิทธิ์ให้เข้าถึง');
	}
}
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post">
				<span class="login100-form-title p-b-37">
					CTF-Craft<center><hr width="50%"></center>เข้าสู่ระบบแอดมิน
				</span>
